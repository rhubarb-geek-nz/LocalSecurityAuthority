...
{
    [Cmdlet(VerbsCommon.Add, "LsaAccountRights")]
    [OutputType(typeof(string))]
    public class AddLsaAccountRights : PSCmdlet
    {
        ...
        [Parameter(Mandatory = true, HelpMessage = "List of rights to add")]
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                throw new ArgumentException("UserRights");
            }
            ...
            try
            {
                using (var uph = new PolicyHandle(0x810, PolicyHandle))
                {
                    int CountOfRights = UserRights.Length;
                    ...
                    try
                    {
                        var result = ADVAPI32.LsaAddAccountRights(uph.ObjectHandle, ptrSid, rights, CountOfRights);
